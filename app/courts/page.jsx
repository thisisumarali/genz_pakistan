...
export default function CourtsPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0a0a0f] text-white px-4 pt-24 pb-20 overflow-hidden">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[400px] sm:w-[600px] h-[300px] bg-lime-400/5 blur-[120px] rounded-full pointer-events-none" />
