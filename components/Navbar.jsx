        ...
        <div className="max-w-[1200px] mx-auto px-6 h-[68px] flex items-center justify-between">
          ...
          <a href="/" className="no-underline flex items-center gap-2.5">
            ...
            <div className="leading-none">
              <div className="font-display font-black text-[17px] tracking-tight text-white flex items-center gap-[1px]">
                <span>Genz</span>
              ...
              <div className="font-body text-[9px] tracking-[0.22em] text-lime-400/60 font-medium uppercase mt-[1px]">
                Indoor Arena
              </div>
            </div>
          </a>
          ...
          <div className="flex items-center gap-3">
            <div className="hidden md:flex items-center gap-1.5 bg-lime-400/[0.08] border border-lime-400/20 rounded-full px-2.5 py-1 text-[11px] text-lime-400 font-display font-bold tracking-[0.1em]">
            ...
            <a
              href="#slot-section"
              className="book-btn hidden md:inline-block px-5 py-2.5 rounded-[10px] border-[1.5px] border-lime-400 text-lime-400 text-xs font-display font-extrabold tracking-[0.1em] no-underline uppercase"
            >
              <span>Book Now</span>
            </a>
          ...
          <div className="mobile-menu bg-[rgba(10,10,15,0.97)] border-t border-white/[0.06] px-6 py-5 md:hidden">
            {navLinks.map((link, i) => (
              <a
                ...
                className={`block py-3 text-white/70 font-display font-bold text-[15px] tracking-[0.06em] no-underline transition-colors hover:text-lime-400 ${
            ...
            <a
              href="#slot-section"
              onClick={() => setMobileOpen(false)}
              className="block mt-4 py-3.5 bg-lime-400 text-black font-display font-black text-[13px] tracking-[0.12em] text-center no-underline rounded-xl uppercase"
            >
              Book Now →
            </a>
          </div>
